...
export function SearchScreen() {
  ...
  const { submitQuestion, investigationActive, activeInvestigation, busy } = useVigsyConversation();
  ...
  const runSearch = async () => {
    ...
    void syncLocalResults(q);
  };

  useEffect(() => {
    if (investigationActive && activeInvestigation?.searchQuery) {
      void syncLocalResults(activeInvestigation.searchQuery);
    }
