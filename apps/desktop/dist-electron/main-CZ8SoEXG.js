...
var ii = (t, e, n) => e in t ? ri(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var _ = (t, e, n) => ii(t, typeof e != "symbol" ? e + "" : e, n);
import { safeStorage as Qt, app as Ae, protocol as $s, BrowserWindow as Ts, ipcMain as N, shell as At, clipboard as oi, dialog as Tn } from "electron";
...
import { execFile as xs } from "node:child_process";
import { promisify as _s } from "node:util";
import { randomUUID as W } from "node:crypto";
const Ns = "KAE", Ls = "Knowledge Acquisition Engine";
function di(t) {
  var s, r;
  if (!t)
    return {
...
const Fs = "C:\\Users\\alber\\Axiom-Knowledge", Os = {
  theme: "dark",
  logLevel: "info",
  maxConcurrentJobs: 2,
...
function tn(t) {
  var p, h, I, b;
  const e = yi(t), n = vi(e), s = wi(e, t, n), r = Us.filter((C) => C !== "Other / Review Needed").map((C) => ({ category: C, score: s[C] })).sort((C, A) => A.score - C.score), i = ((p = r[0]) == null ? void 0 : p.score) ?? 0, o = ((h = r[1]) == null ? void 0 : h.score) ?? 0;
  let c = r.filter((C) => C.score >= Dn).map((C) => C.category), a = !1, l, d;
  i < gi || i === 0 ? (a = !0, l = "Other / Review Needed", c = c.length > 0 ? [...c, "Other / Review Needed"] : ["Other / Review Needed"], d = `Low classification confidence (top score ${i}). Routed to review.`) : i === o && i >= Dn ? (a = !0, l = "Other / Review Needed", c = [.../* @__PURE__ */ new Set([...c, "Other / Review Needed"])], d = `Tied scores between "${(I = r[0]) == null ? void 0 : I.category}" and "${(b = r[1]) == null ? void 0 : b.category}". Routed to review.`) : (l = r[0].category, c.length === 0 && (c = [l]), d = `Primary match "${l}" (score ${i}) from title, content, and recurring terms.`);
  ...
  return {
    ...
    inferredProject: Ii(l, t.title, n),
...
function nn(t) {
  ...
  for (const n of t)
    e.set(String(n.metadata.conversationId ?? n.id), tn(n));
  return e;
}
function yi(t) {
...
function wi(t, e, n) {
  const s = Object.fromEntries(Us.map((r) => [r, 0]));
  for (const [r, i] of Object.entries(Wt))
    for (const o of i)
  ...
  for (const r of n.slice(0, 5))
    for (const [i, o] of Object.entries(Wt))
...
async function an(t, e, n) {
  ...
  const a = sn(t.id, c), l = rn(t.id, e, a);
...
const Si = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  emitImportPackage: on,
  generateProvenance: rn,
  generateSourceRecords: sn,
  runConnectorPipeline: an
...
class ki {
  async export(e, n, s) {
    throw new Ps(`Exporter "${this.name}"`);
  }
}
function Ri(t) {
...
function bi() {
  if (Nn) return Dt;
  Nn = 1;
  const t = ci, e = en, n = Ms(), s = cn(), r = typeof process == "object" && process.platform === "win32", i = (a) => typeof a == "object" && a !== null, o = new Uint32Array(256).map((a, l) => {
    for (let d = 0; d < 8; d++)
  ...
  return Dt = c, c.prototype.makeDir = function(a) {
    const l = this;
    function d(u) {
...
var Fn;
function Ye() {
  return Fn || (Fn = 1, de.exports = bi(), de.exports.Constants = Ms(), de.exports.Errors = cn(), de.exports.FileAttr = Ai(), de.exports.decoder = $i()), de.exports;
}
var it = {}, Nt, On;
function Ti() {
  if (On) return Nt;
  On = 1;
  var t = Ye(), e = t.Constants;
  return Nt = function() {
...
var Mn;
function js() {
  return Mn || (Mn = 1, it.EntryHeader = Ti(), it.MainHeader = Di()), it;
}
var Ue = {}, Pt, jn;
function xi() {
  return jn || (jn = 1, Pt = function(t) {
    var e = Ds, n = { chunkSize: (parseInt(t.length / 1024) + 1) * 1024 };
    return {
      deflate: function() {
...
function Ni() {
  if (Kn) return Ot;
  Kn = 1;
  const { randomFillSync: t } = ui, e = cn(), n = new Uint32Array(256).map((p, h) => {
    for (let I = 0; I < 8; I++)
  ...
  return Ot = { decrypt: d, encrypt: f, _salter: u }, Ot;
}
var Gn;
function Li() {
  return Gn || (Gn = 1, Ue.Deflater = xi(), Ue.Inflater = _i(), Ue.ZipCrypto = Ni()), Ue;
}
var Ut, zn;
function Bs() {
  if (zn) return Ut;
  zn = 1;
  var t = Ye(), e = js(), n = t.Constants, s = Li();
  return Ut = function(r, i) {
...
function Pi() {
  if (Hn) return Mt;
  Hn = 1;
  const t = Bs(), e = js(), n = Ye();
  return Mt = function(s, r) {
...
function Fi() {
  if (Zn) return jt;
  Zn = 1;
  const t = Ye(), e = en, n = Bs(), s = Pi(), r = (...a) => t.findLast(a, (l) => typeof l == "boolean"), i = (...a) => t.findLast(a, (l) => typeof l == "string"), o = (...a) => t.findLast(a, (l) => typeof l == "function"), c = {
...
var Oi = Fi();
const Ks = /* @__PURE__ */ Ri(Oi), Ui = /KRC-(\d{4})/gi, Mi = /## ChatGPT Conversation ID\s*\n([^\n]+)/, ji = [
  "VIGS",
  "Founder_OS",
  "Axiom",
  "Book",
...
async function un(t) {
  ...
  for (const s of n) {
    ...
    s.isDirectory() ? e.push(...await un(r)) : s.name.endsWith(".md") && e.push(r);
  }
  return e;
}
async function vt(t) {
  let e = 0;
  const n = S.join(t, "Sources"), s = await un(n);
  for (const i of s) {
...
async function dn(t) {
  const e = /* @__PURE__ */ new Map(), n = S.join(t, "Sources"), s = await un(n);
  for (const r of s) {
    const o = S.basename(r).match(/^(KRC-\d{4})/i);
    if (!o)
      continue;
    const a = (await R.readFile(r, "utf8")).match(Mi);
...
function Yi(t, e, n) {
  const s = e.title.trim() || "Untitled Conversation", r = String(e.metadata.conversationId ?? e.id), i = (/* @__PURE__ */ new Date()).toISOString().slice(0, 10), o = e.metadata.messageCount ?? 0, c = [
    ...
    "",
    "## Create Time",
    qn(e.metadata.createTime),
    "",
    "## Update Time",
    qn(e.metadata.updateTime),
    "",
    "## Extraction Status",
...
function Ji(t) {
  ...
  return t.classified.length > 0 && e.push("### Classified", "", ot(t.classified), ""), t.uncertain.length > 0 && e.push("### Uncertain / Review Needed", "", ot(t.uncertain), ""), t.skipped.length > 0 && e.push("### Skipped", "", ot(t.skipped), ""), t.errors.length > 0 && e.push("### Errors", "", ot(t.errors), ""), e.push("---", ""), e.join(`
`);
}
function ot(t) {
  const e = "| KRC ID | Title | Primary Category | All Categories | Confidence | Status | Notes |", n = "|---|---|---|---|---|---|---|", s = t.map((r) => {
    ...
    return `| ${r.krcId} | ${Wn(r.title)} | ${r.primaryCategory} | ${r.categories.join(", ")} | ${r.confidence}% | ${r.status} | ${Wn(i)} |`;
  });
  return [e, n, ...s].join(`
`);
}
...
` + Ji(e), await R.writeFile(n, s, "utf8"), n;
}
function eo(t, e) {
  const s = new Ks(t).getEntries(), r = /* @__PURE__ */ new Map();
  for (const o of s)
...
async function Vs(t, e, n) {
  ...
  let u = await vt(e) + 1;
  const f = await dn(e), p = [], h = `KAE Import — ${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}`, I = S.join(e, "Uploads", `chatgpt-import-${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}`);
  let b = !1;
  const C = {
  ...
  for (const x of t) {
    ...
    const O = String(x.metadata.conversationId ?? x.id), M = d.get(O) ?? tn(x);
    x.metadata.classification = M;
    const K = f.get(O), G = Zs(M);
    let B, V;
    K ? (B = K, V = !0, (y = n == null ? void 0 : n.log) == null || y.call(n, "info", `Updating existing source ${B} for conversation ${O}`)) : (B = It(u), u++, V = !1);
    const J = Hs(B, x), we = S.join(e, "Sources", G, J), ve = `Sources/${G}/${J}`, Ne = Yi(B, x, M), Le = zs(B, x), st = S.join(e, "ExecutiveSessions", G, Le), Pe = `ExecutiveSessions/${G}/${Le}`, rt = Hi(B, x, M, ve), P = {
      krcId: B,
      conversationId: O,
      title: x.title,
    ...
    try {
      ...
      f.set(O, B), z === "created" ? (i++, r.push(B), p.push(fn(B, x.title, Ne, M.uncertain ? "Review Needed" : M.primaryCategory))) : z === "updated" && (P.status = "updated"), await Vn(st, rt, V), o++, (E = n == null ? void 0 : n.log) == null || E.call(n, "info", `Executive session: ${Pe}`), M.uncertain ? (l++, P.status = P.status === "updated" ? "updated" : "uncertain", C.uncertain.push(P)) : (a++, C.classified.push(P)), (k = n == null ? void 0 : n.log) == null || k.call(n, "info", `${z === "created" ? "Created" : "Updated"} [${M.primaryCategory}] ${B}: ${ve}`), b || (await to(I, x, n), b = !0);
    } catch (z) {
  ...
  let g;
  try {
    p.length > 0 && await ln(e, p), await Vi(e, p.length, h), g = await Qi(e, C), (U = n == null ? void 0 : n.log) == null || U.call(n, "info", `Import review written: ${g}`);
  } catch (x) {
...
async function to(t, e, n) {
  ...
  let i;
  r && (n != null && n.sourceZipPath) && ((o = n.log) == null || o.call(n, "info", `Extracting ${s.length} asset(s) from ZIP at write time`), i = eo(n.sourceZipPath, s));
  for (const a of s) {
    const l = a.dataBase64 ? Buffer.from(a.dataBase64, "base64") : i == null ? void 0 : i.get(a.zipPath);
    if (!l || !a.fileName)
      continue;
    const d = S.join(t, a.fileName);
    await Bi(d, l, !1) !== "skipped" && ((c = n == null ? void 0 : n.log) == null || c.call(n, "info", `Preserved asset: Uploads/${S.basename(t)}/${a.fileName}`));
  }
}
class no extends ki {
  constructor() {
...
function Ws(t, e) {
  ...
  const c = n.length + s.length > 0, a = c ? [...so] : [], l = c ? [e.replace("{timestamp}", "<timestamp>")] : [], d = [...n, ...s, ...r, ...i];
  return {
    sourcesAdded: n,
    sourcesUpdated: s,
    sessionsAdded: r,
...
async function ro(t, e, n) {
  ...
  const u = nn(t);
  let f = await vt(e) + 1;
  const p = await dn(e), h = S.join(e, "Sources"), I = S.join(e, "Uploads", "chatgpt-import-{timestamp}"), b = S.join(e, "ExecutiveSessions"), C = S.join(e, "Registries", "SOURCE_REGISTRY.md"), A = S.join(e, "Registries", "IMPORT_REVIEW.md");
  let T = 0;
  const g = [], m = t[0];
  if (m) {
  ...
  for (const w of t) {
    const E = String(w.metadata.conversationId ?? w.id), k = u.get(E) ?? tn(w), $ = p.get(E), U = Zs(k);
    let D, x;
    $ ? (D = $, x = "update") : (D = It(f), f++, x = "create");
    const O = Hs(D, w), M = S.join(h, U, O), K = `Sources/${U}/${O}`, G = zs(D, w), B = `ExecutiveSessions/${U}/${G}`;
    if (x === "create")
      try {
  ...
  const v = i.length === 0 && t.length > 0, y = Ws(o, I);
  return {
    valid: v,
    fileName: n,
    filePath: "",
...
function io(t, e, n, s) {
  return {
    ...
    blockingErrors: [s],
    plannedRecords: [],
    diffPreview: Ws([], S.join(n, "Uploads", "chatgpt-import-{timestamp}")),
    validatedAt: (/* @__PURE__ */ new Date()).toISOString(),
    outputLocations: {
...
const mn = 1, Ys = ".kae-connectors", Js = "connectors.json";
function Yn() {
  return {
    version: mn,
    connectors: {},
...
async function X(t, e) {
  ...
  const s = S.join(n, Js);
  return await R.writeFile(s, JSON.stringify({ ...e, version: mn }, null, 2), "utf8"), s;
}
const Jn = _s(xs);
async function ao(t) {
  try {
...
async function uo(t, e) {
  ...
  let s = !1, r, i = !1;
  try {
    const { stdout: f } = await Jn("git", ["rev-parse", "--abbrev-ref", "HEAD"], {
      cwd: t
    });
    r = f.trim(), s = !0, n.push({
      id: "git-repo",
  ...
  if (s)
    try {
      const { stdout: f } = await Jn("git", ["status", "--porcelain"], {
        cwd: t
      });
...
async function ye(t) {
  ...
  const o = await es(S.join(t, "Sources")), c = await es(S.join(t, "ExecutiveSessions")), a = /* @__PURE__ */ new Map();
  for (const b of c) {
    const A = S.basename(b).match(Qn);
    A != null && A[0] && a.set(A[0], b);
  }
  for (const b of o) {
    const C = S.basename(b), A = ts(t, b), T = C.match(Qn);
    if (!T) {
      q(e, {
        severity: "info",
        category: "info",
  ...
  let l = !1, d, u;
  try {
    const { stdout: b } = await Xn("git", ["rev-parse", "--abbrev-ref", "HEAD"], {
      cwd: t
  ...
  return h.statusLevel = I.level, h.statusHeadline = I.headline, h.statusSubline = I.subline, h.gitReadiness = await uo(t, h), h;
}
async function Xs(t, e) {
  ...
  for (const s of n) {
    ...
    s.isDirectory() ? await Xs(r, i) : await R.copyFile(r, i);
  }
}
async function Qs(t, e) {
  ...
  for (const i of r) {
    const o = S.join(t, i);
    try {
      await R.access(o), await Xs(o, S.join(s, i));
    } catch {
    }
  }
  return s;
...
async function er(t) {
  const n = (await Et(t)).filter((r) => r.category === "sources" && tr(r.name)), s = [];
  for (const r of n) {
    let i = "";
    try {
      i = (await Ze(t, r.relativePath)).slice(0, 4096);
    } catch {
    }
    const o = po(i), c = o.updateTime ?? o.createTime ?? r.modifiedAt ?? "";
    s.push({
      name: r.name,
...
function pn(t) {
  ...
  return {
    ...
    fileReferences: ho(he(s, "File References")),
    messages: i
  };
}
function hn(t, e) {
...
async function wo(t, e) {
  ...
  if (!n)
    return [];
  const s = await sr(t, n), r = [], i = /* @__PURE__ */ new Set();
  for (const o of e) {
    const c = rr(o, s);
    if (!c || i.has(c))
      continue;
...
function vo(t, e) {
  var d;
  const n = t.match(/^#\s*Executive Session Record\s*[—–-]\s*(.+)$/m), s = ((d = n == null ? void 0 : n[1]) == null ? void 0 : d.trim()) ?? e.replace(/\.md$/i, ""), r = Me(t, "Source ID"), i = Me(t, "Session Date"), o = Me(t, "Session Summary") ?? "", c = Me(t, "Transcript Reference"), a = [];
  c && a.push(c);
...
const Te = ".kae-index", Io = "evidence-index.json", ir = 1;
function St(t) {
  return S.join(t, Te, Io);
}
async function or(t) {
  const e = St(t);
  try {
    const n = await R.readFile(e, "utf8"), s = JSON.parse(n);
    return s.version !== ir || !Array.isArray(s.records) ? null : s;
  } catch {
    return null;
  }
}
...
function He(t) {
  const e = t.toLowerCase().replace(/[^\w\s-]/g, " ").split(/\s+/).filter((n) => n.length > 1 && !Eo.has(n));
  return [...new Set(e)];
}
function De(t) {
  const e = t.trim();
...
function ar(t) {
  return tr(t) ? "chatgpt-import" : t.startsWith("KRC-") ? "krc-source" : "markdown";
}
function Co(t) {
  const e = {
...
function ko(t, e, n, s) {
  ...
  r.messages.forEach((d, u) => {
    const f = `${r.krcId}:msg:${u}`, p = He(d.text);
  ...
  for (const d of a) {
    const u = `${r.krcId}:att:${d}`, f = n ? rr(d, n) : null, p = S.basename(d);
    let h;
...
async function Xe(t) {
  const e = await Et(t), n = [], s = await nr(t), r = s ? await sr(t, s) : null;
  for (const c of e) {
    if (!c.relativePath.endsWith(".md") || c.category !== "sources" && c.category !== "sessions")
      continue;
    let a;
    try {
      a = await Ze(t, c.relativePath);
    } catch {
      continue;
    }
    if (c.category === "sessions") {
      bo(c.relativePath, a, n);
      continue;
    }
    pn(a) ? ko(c.relativePath, a, r, n) : Ro(c.relativePath, a, n);
  }
  ...
  return await So(t, o), o;
}
function Ao(t) {
  const e = Co(t.records);
...
function No(t, e, n) {
  ...
  if (t.kind === "message" && t.message) {
    ...
    (f || p > 0) && (r += f ? 30 : p * 8, s.add("message"), s.add("keyword"), $o(t.message.role) && (s.add("prompt"), f && (r += 10)), To(t.message.role) && (s.add("response"), f && (r += 10)));
  }
  if (t.kind === "executive_session") {
    const u = at(t);
...
function ur(t, e, n = 50) {
  const s = e.trim();
  if (!s)
    return [];
  const r = De(s), i = [];
  for (const o of t.records) {
    const { score: c, matchFields: a } = No(o, s, r);
    c <= 0 || a.length === 0 || i.push(Lo(o, c, a));
  }
...
async function xe(t) {
  const e = await or(t);
  return e && e.repositoryPath === t ? e : Xe(t);
}
async function lr(t, e, n = 50) {
  const s = await xe(t);
  return ur(s, e, n);
}
function Po(t) {
...
async function Et(t) {
  const e = [];
  try {
    await R.access(t), await fr(t, t, e);
  } catch {
    return [];
  }
...
async function Uo(t, e, n = 50) {
  const s = e.toLowerCase(), r = await Et(t), i = [];
  for (const o of r) {
    if (!o.relativePath.endsWith(".md"))
      continue;
    let c;
    try {
      c = await Ze(t, o.relativePath);
    } catch {
      continue;
    }
...
async function mr(t) {
  ...
  return {
    ...
    registryCount: n,
    lastImportDate: await jo(t),
    lastSnapshotPath: await Mo(t),
    healthReady: e.ready,
...
async function Go(t, e) {
  ...
  await R.mkdir(n, { recursive: !0 });
  const r = `import-report-${e.generatedAt.replace(/[:.]/g, "-")}.md`, i = S.join(n, r), o = Ko({ ...e });
...
async function Ho(t) {
  const e = S.join(t, "Sources"), n = await hr(e), s = [];
  for (const r of n) {
    const i = gr(t, r), o = S.basename(r), c = await R.stat(r);
    s.push({
      absolutePath: r,
      relativePath: i,
      fileName: o,
      krcId: yr(o),
      categoryFolder: wr(i, "Sources"),
      mtimeMs: c.mtimeMs
    });
  }
  return s;
...
async function Zo(t) {
  const e = S.join(t, "ExecutiveSessions"), n = await hr(e), s = [];
  for (const r of n) {
    const i = gr(t, r), o = S.basename(r);
    s.push({
      absolutePath: r,
      relativePath: i,
      fileName: o,
      krcId: yr(o),
      categoryFolder: wr(i, "ExecutiveSessions")
    });
  }
  return s;
}
...
async function qo(t) {
  const e = S.join(t, "Uploads");
  return await pr(e) ? (await R.readdir(e, { withFileTypes: !0 })).filter((s) => s.isDirectory()).map((s) => `Uploads/${s.name}`) : [];
}
function re(t, e, n, s) {
  return {
    id: W(),
...
async function Wo(t) {
  const e = [], n = await Ho(t), s = await Zo(t), r = await Vo(t), i = await qo(t), o = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), a = new Map(r.map((d) => [d.krcId, d]));
  for (const d of n) {
    if (!d.krcId) {
...
const Xo = "Generated by KAE Repository Repair because source KRC existed without matching executive session.";
function vr(t, e, n, s = Xo) {
...
function Ir(t, e) {
  return `${t}_${Je(e)}_SESSION.md`;
}
function Qo(t, e) {
  return `${t}_${Je(e)}.md`;
}
const ea = (t, e, n) => `Reassigned from ${t} to ${e} by KAE Repository Repair on ${n}. Canonical record retains ${t}; this duplicate was preserved with a new ID.`;
async function ta(t, e, n, s) {
  ...
  const i = String(((v = e.metadata) == null ? void 0 : v.oldKrcId) ?? ""), o = S.join(t, r), c = await R.readFile(o, "utf8"), a = gn(c, r);
  n.value += 1;
  const l = It(n.value), d = (/* @__PURE__ */ new Date()).toISOString().slice(0, 10), u = ea(i, l, d), f = Jo(c, i, l, u), p = S.join(t, "Sources", a.categoryFolder), h = Qo(l, a.title), I = S.join(p, h), b = `Sources/${a.categoryFolder}/${h}`;
  ...
  const A = Ir(l, a.title), T = S.join(C, A), g = `ExecutiveSessions/${a.categoryFolder}/${A}`, m = vr(l, b, { ...a, title: a.title }, `Generated by KAE Repository Repair after reassigning duplicate ${i} → ${l}.`);
  return await R.writeFile(T, m, "utf8"), await ln(t, [
    fn(l, a.title, f, a.primaryProduct)
...
async function na(t, e, n) {
  ...
  const r = String(((p = e.metadata) == null ? void 0 : p.krcId) ?? ""), i = S.join(t, s), o = await R.readFile(i, "utf8"), c = gn(o, s), a = S.join(t, "ExecutiveSessions", c.categoryFolder);
  await R.mkdir(a, { recursive: !0 });
  const l = Ir(r || c.krcId, c.title), d = S.join(a, l), u = `ExecutiveSessions/${c.categoryFolder}/${l}`;
  if (await ra(d))
    return {
      actionId: e.id,
      type: e.type,
...
async function sa(t, e, n) {
  ...
  const r = S.join(t, s), i = await R.readFile(r, "utf8"), o = gn(i, s);
  return await ln(t, [
    fn(o.krcId, o.title, i, o.primaryProduct)
...
async function ia(t, e = {}) {
  ...
  const o = await Qs(r, s);
  n("info", `Pre-repair snapshot created: ${o}`, { snapshotPath: o });
  const c = t.actions.filter((h) => h.autoRepairSafe && !h.manualReviewRequired), a = t.actions.length - c.length, d = { value: await vt(r) }, u = [], f = [];
  for (const h of c)
    try {
      let I;
      switch (h.type) {
...
function ma(t, e) {
  ...
  return t.message.text.toLowerCase().includes(n) || De(e).some((s) => t.message.text.toLowerCase().includes(s));
}
function pa(t, e) {
  if (!e || !t.attachment)
    return !1;
  const n = e.toLowerCase(), s = t.attachment.filename.toLowerCase();
  return s.includes(n) || De(e).some((r) => s.includes(r));
}
function ha(t, e, n, s, r) {
  const i = [];
...
function ga(t, e, n, s, r = 5) {
  ...
  for (const a of t.records) {
    ...
    let u = He(l).filter((f) => i.has(f)).length;
...
function ya(t) {
  ...
  for (const o of t) {
    if (o.kind === "message" && o.message) {
      const c = o.message.timestamp ?? ((n = o.conversation) == null ? void 0 : n.updated) ?? "", a = ns(c);
      (!e || a >= e.ms) && (e = { record: o, timestamp: c, ms: a });
    }
    if (o.kind === "attachment" && ((s = o.attachment) != null && s.resolved)) {
      const c = ((r = o.conversation) == null ? void 0 : r.updated) ?? ((i = o.conversation) == null ? void 0 : i.created) ?? "", a = ns(c);
      (!e || a >= e.ms) && (e = { record: o, timestamp: c, ms: a });
    }
  }
...
function Sr(t, e, n) {
  var E, k, $, U, D, x, O, M, K, G, B, V, J, we, ve, Ne, Le, st, Pe, rt;
  const s = ua(t, e);
  if (!s)
    return null;
  const { krcId: r, sourcePath: i } = aa(s), o = r ? ca(t, r) : [s], c = (r ? da(o, r) : void 0) ?? t.records.find((P) => P.kind === "source" && P.repository.repositoryPath === i) ?? (s.kind === "source" ? s : void 0), a = r ? la(o, r) : void 0, l = a ?? c, d = fa(t, r), u = ((E = a == null ? void 0 : a.conversation) == null ? void 0 : E.title) ?? ((k = l == null ? void 0 : l.conversation) == null ? void 0 : k.title) ?? (($ = s.conversation) == null ? void 0 : $.title) ?? ((U = c == null ? void 0 : c.conversation) == null ? void 0 : U.title) ?? "Untitled", f = o.filter((P) => P.kind === "message").sort((P, z) => {
    var Fe, Oe;
    const Y = Number(((Fe = P.message) == null ? void 0 : Fe.messageId.split(":msg:")[1]) ?? 0), An = Number(((Oe = z.message) == null ? void 0 : Oe.messageId.split(":msg:")[1]) ?? 0);
    return Y - An;
  }), p = o.filter((P) => P.kind === "attachment"), h = ga(t, r, u, n), I = ya(o), b = ha(s, r, u, n, d), C = ie("sourceFile", "Source File", [
    ...
    return oe(`${((z = P.message) == null ? void 0 : z.role) ?? "Message"}: ${P.excerpt}`, i, {
      ...
      highlighted: P.id === s.id || ma(P, n)
    });
  }), "No messages indexed."), g = ie("attachments", "Attachments", p.map((P) => {
    var Fe, Oe, $n;
    const z = ((Fe = P.attachment) == null ? void 0 : Fe.filename) ?? "Attachment", Y = oa(z, (Oe = P.attachment) == null ? void 0 : Oe.assetPath);
    return oe(`${Y === "image" ? "Screenshot" : Y === "video" ? "Video" : "File"}: ${z}`, i, {
      recordId: P.id,
      kind: "attachment",
      subtitle: ($n = P.attachment) != null && $n.resolved ? P.attachment.assetPath : "Unresolved reference",
      highlighted: P.id === s.id || pa(P, n)
    });
  ...
  if (y.push({
    ...
    explorerPath: ((Ne = h[0]) == null ? void 0 : Ne.repository.repositoryPath) ?? i,
    recordId: (Le = h[0]) == null ? void 0 : Le.id
  }), I) {
    const P = I.record.kind === "message" ? `${(st = I.record.message) == null ? void 0 : st.role}: ${I.record.excerpt}` : ((Pe = I.record.attachment) == null ? void 0 : Pe.filename) ?? I.record.excerpt;
    y.push({
    ...
    y.push({
      kind: "newest_evidence",
      label: s.excerpt || u,
      timestamp: (rt = a == null ? void 0 : a.conversation) == null ? void 0 : rt.updated,
      explorerPath: i,
      recordId: s.id
    });
...
function Re(t, e, n) {
  const s = t.groundedAnswer.directAnswer.trim(), r = t.groundedAnswer.reasonedSummary.trim(), i = va[e], o = Ia[e], c = /^here'?s what i found/i.test(s) ? s.replace(/^here'?s what i found:?\s*/i, `${i} `) : `${i} ${s}`;
  return {
    providerId: e,
    model: n ?? "offline",
    directAnswer: c,
  ...
  return {
    ...
    async reason(c, a) {
      ...
      try {
        ...
        const p = await f.json(), h = i(p), I = h ? await Ea(h) : null;
        return I ? {
          providerId: t,
          model: l,
...
const Ra = Qe("openai", "OpenAI", "gpt-4o-mini", () => "https://api.openai.com/v1/chat/completions", (t, e) => ({
  model: e,
  messages: [
...
}, !0), ba = Qe("claude", "Claude", "claude-3-5-haiku-latest", () => "https://api.anthropic.com/v1/messages", (t, e) => ({
  model: e,
  max_tokens: 1024,
...
}, !0), Aa = Qe("gemini", "Gemini", "gemini-1.5-flash", (t) => `https://generativelanguage.googleapis.com/v1beta/models/${t.model ?? "gemini-1.5-flash"}:generateContent?key=${t.apiKey ?? ""}`, (t) => ({
...
}, !0), $a = Qe("openrouter", "OpenRouter", "openai/gpt-4o-mini", () => "https://openrouter.ai/api/v1/chat/completions", (t, e) => ({
  model: e,
  messages: [{ role: "user", content: t }]
}), (t) => {
  var n, s, r;
  return ((r = (s = (n = t.choices) == null ? void 0 : n[0]) == null ? void 0 : s.message) == null ? void 0 : r.content) ?? null;
}, !0), Ta = Qe("ollama", "Local (Ollama)", "llama3.2", (t) => `${t.baseUrl ?? "http://127.0.0.1:11434"}/api/chat`, (t, e) => ({
  model: e,
  stream: !1,
  messages: [{ role: "user", content: t }]
}), (t) => {
...
async function rs(t, e, n, s) {
  if (s.offline || t === "mock" || t === "deterministic")
    return Da(t, s.supportsStreaming, n);
  if (s.requiresApiKey && !(e != null && e.apiKey))
    return ss(t, s.supportsStreaming, n);
  if (t === "openai" || t === "openrouter")
    return xa(t, t === "openrouter" ? "https://openrouter.ai/api/v1/chat/completions" : "https://api.openai.com/v1/chat/completions", (e == null ? void 0 : e.apiKey) ?? "", s.supportsStreaming, n);
  if (t === "ollama") {
...
function Na(t) {
  return {
    ...
    async reasonStream(e, n, s) {
      const r = Re(e, "mock");
      return pt("mock", "direct_answer", r.directAnswer, s), pt("mock", "summary", r.reasonedSummary, s), s({ kind: "done", text: "", providerId: "mock" }), _a("mock", r.directAnswer, r.reasonedSummary, !0);
    }
  };
}
class La {
  ...
  async testActiveProviderHealth() {
    ...
    return rs(e.capabilities.id, this.credentials, this.secureStorageMode, e.capabilities);
  }
  async testProviderHealth(e) {
    const n = this.providers.get(e);
    if (!n)
      throw new Error(`Unknown AI provider: ${e}`);
    return rs(e, this.credentials, this.secureStorageMode, n.capabilities);
  }
}
function Pa() {
  return [
...
function Q(t, e, n) {
  const s = Ua(n.fromId, n.relationshipType, n.toId);
...
function ct(t, e, n, s) {
  ...
  for (const [l, d] of c) {
    ...
    if (!p || !h || s.skipSameKrc && p.repository.krcId === h.repository.krcId)
      continue;
    const I = Ba(o.get(u) ?? /* @__PURE__ */ new Set(), o.get(f) ?? /* @__PURE__ */ new Set());
    Q(e, n, {
      fromId: p.id,
      toId: h.id,
...
function za(t) {
  ...
  const e = [], n = /* @__PURE__ */ new Set(), s = Ma(t), r = /* @__PURE__ */ new Map();
  ...
  for (const [m, v] of s.entries()) {
    const y = is(v), w = v.find(($) => $.kind === "source"), E = v.filter(($) => $.kind === "attachment");
    y && w && Q(e, n, {
      fromId: y.id,
      toId: w.id,
...
const Ha = "relationship-index.json", Za = 1;
function Ct(t) {
  return S.join(t, Te, Ha);
}
async function Er(t) {
  try {
    const e = await R.readFile(Ct(t), "utf8"), n = JSON.parse(e);
    return n.version !== Za || !Array.isArray(n.relationships) ? null : n;
  } catch {
    return null;
  }
}
...
async function $e(t) {
  const e = await xe(t), n = za(e), s = (/* @__PURE__ */ new Date()).toISOString(), r = {
    version: 1,
    repositoryPath: t,
    builtAt: s,
  ...
  return await Va(t, r), r;
}
async function Ve(t) {
  const e = await Er(t);
  return e && e.repositoryPath === t ? e : $e(t);
}
function Ja(t) {
  const e = {};
...
function Yt(t, e, n = 50) {
  const s = De(e), r = e.toLowerCase(), i = [];
...
async function kr(t, e, n, s = 20) {
  const [r, i] = await Promise.all([
    xe(t),
    Ve(t)
  ]);
  let o = Cr(i, e);
  o.length === 0 && n && (o = Yt(i, n, s * 3)), o.length === 0 && (o = Yt(i, e, s * 3));
  const c = [], a = /* @__PURE__ */ new Set();
  for (const l of o.sort((d, u) => u.confidence - d.confidence)) {
    const d = l.fromId === e || l.supportingEvidenceIds[0] === e ? l.toId : l.fromId, u = Ya(r, d);
    if (!(!u || a.has(u.id)) && (a.add(u.id), c.push(Wa(u, l)), c.length >= s))
      break;
  }
  return c;
}
...
const Qa = [
  ...
  /\bour decision\b/i,
  /\bdecide about\b/i
], ec = [/\bsummarize\b/i, /\bsummary of\b/i, /\bgive me an overview\b/i], tc = [
  /\bshow evidence\b/i,
  /\bprove that\b/i,
  /\bevidence that\b/i,
  /\bdemonstrate\b/i
...
function Rr(t) {
  const e = t.trim();
  return Qa.some((n) => n.test(e)) ? "decision" : ec.some((n) => n.test(e)) ? "summarize" : tc.some((n) => n.test(e)) ? "show_evidence" : nc.some((n) => n.test(e)) ? "blockers" : "general";
}
function rc(t) {
  let e = t.trim();
  for (const n of sc)
...
const ic = ["decided", "decision", "agreed", "conclusion", "resolved", "plan"], oc = [
  "blocker",
  "unresolved",
  "remaining",
  "issue",
...
function yn(t) {
  ...
  return oc.some((n) => e.includes(n));
}
function kt(t) {
  const e = t.toLowerCase();
  return ic.some((n) => e.includes(n));
}
function ac(t) {
  if (!t)
    return 0;
...
function ht(t) {
  var e, n, s;
  return ac(((e = t.message) == null ? void 0 : e.timestamp) ?? ((n = t.conversation) == null ? void 0 : n.updated) ?? ((s = t.conversation) == null ? void 0 : s.created));
}
function wn(t) {
  var e, n, s, r;
  return [
...
function cc(t) {
  return t.kind === "executive_session" ? 92 : kt(wn(t)) ? 78 : 65;
}
function os(t, e) {
...
function uc(t) {
  const e = t.filter((r) => {
    const i = wn(r);
    return r.kind === "executive_session" || kt(i);
  }).sort((r, i) => ht(i) - ht(r)).slice(0, 4), n = e[0], s = n ? cc(n) : 50;
  return {
    cardId: "recent-decisions",
    category: "recent_decision",
    title: "Recent Decisions",
    summary: n ? `${br(n)} — ${n.excerpt.slice(0, 140)}${n.excerpt.length > 140 ? "…" : ""}` : "No indexed decision evidence found yet.",
    whyItMatters: "Recent decisions anchor what the team agreed to and what Vigsy can ground answers on.",
    confidence: s,
    evidenceLinks: e.map(vn)
  };
}
function dc(t, e) {
  const n = e.issues.filter((a) => a.severity === "error" || a.severity === "warning"), s = t.filter((a) => yn(wn(a))).sort((a, l) => ht(l) - ht(a)).slice(0, 4), r = [
    ...n.slice(0, 2).map(Ar),
    ...s.map(vn)
...
function mc(t, e) {
  ...
  const [i, { count: o, rel: c }] = r, a = os(t, c.toId) ?? os(t, c.fromId) ?? t[0];
  return {
    cardId: "high-relationship-topic",
    category: "high_relationship_topic",
...
function hc(t) {
  ...
  return {
    ...
    confidence: e,
    evidenceLinks: t.issues.length > 0 ? t.issues.slice(0, 4).map(Ar) : [
      {
...
const gc = "executive-briefing-cache.json", Tr = 1;
function Dr(t) {
  return S.join(t, Te, gc);
}
async function yc(t) {
  const e = St(t), n = Ct(t), [s, r] = await Promise.all([
    or(t),
    Er(t)
  ]);
  let i = 0, o = 0;
...
async function wc(t) {
  try {
    const e = await R.readFile(Dr(t), "utf8"), n = JSON.parse(e);
    return n.version !== Tr || !n.briefing || !Array.isArray(n.briefing.cards) ? null : n;
  } catch {
    return null;
  }
}
async function xr(t, e, n) {
  const s = await yc(t), r = {
    version: Tr,
    repositoryPath: t,
...
async function vc(t, e) {
  try {
    if ((await R.stat(St(t))).mtimeMs > e.evidenceIndexMtimeMs)
      return !0;
  } catch {
    return !0;
  }
  try {
    if ((await R.stat(Ct(t))).mtimeMs > e.relationshipIndexMtimeMs)
      return !0;
  } catch {
    return !0;
  }
...
async function _r(t) {
  ...
  if (!e || e.repositoryPath !== t) {
    const s = await $r(t);
    return await xr(t, s), { briefing: s, fromCache: !1, stale: !1 };
  }
...
async function et(t) {
  const e = await $r(t);
  return await xr(t, e), e;
}
const Ic = "executive-memory", Nr = "Albert";
function Rt(t) {
  return S.join(t, ".kae-sessions", Ic);
}
function Lr(t) {
  return S.join(Rt(t), "manifest.json");
}
function Jt(t, e) {
  return S.join(Rt(t), "sessions", `${e}.json`);
}
function Pr(t, e) {
  return S.join(Rt(t), "archive", `${e}.json`);
}
async function Fr(t) {
  const e = Rt(t);
...
async function Or(t, e) {
  await Fr(t), await R.writeFile(Lr(t), JSON.stringify(e, null, 2), "utf8");
}
async function bt(t, e) {
  const s = (await tt(t)).sessions.find((r) => r.conversationId === e);
  return s ? In(t, s.sessionId) : null;
}
async function In(t, e) {
  for (const n of [
    () => R.readFile(Jt(t, e), "utf8"),
    () => R.readFile(Pr(t, e), "utf8")
  ])
    try {
...
async function Ur(t) {
  const e = await tt(t);
  return e.activeSessionId ? In(t, e.activeSessionId) : null;
}
async function qe(t, e, n) {
  await Fr(t);
  const s = n != null && n.archive ? Pr(t, e.sessionId) : Jt(t, e.sessionId);
  if (await R.writeFile(s, JSON.stringify(e, null, 2), "utf8"), n != null && n.archive)
    try {
      await R.unlink(Jt(t, e.sessionId));
    } catch {
    }
}
function Mr(t, e = "Vigsy conversation") {
...
async function gt(t, e, n = !0) {
  ...
  return r >= 0 ? s.sessions[r] = i : s.sessions.push(i), await Or(t, s), s;
}
async function Sc(t, e) {
  ...
  for (const d of s) {
    const u = await kr(t, d, e.searchQuery, 12);
    r.push(...u);
  }
  const i = /* @__PURE__ */ new Map();
  for (const d of r) {
...
function as(t) {
  var r, i, o;
  const e = ((r = t.message) == null ? void 0 : r.timestamp) ?? ((i = t.conversation) == null ? void 0 : i.updated) ?? ((o = t.conversation) == null ? void 0 : o.created) ?? "", n = Ec(e);
  if (!n)
    return 0;
...
function Cc(t, e, n) {
  ...
  if (e === "decision" && (t.kind === "executive_session" && (r += 45, s.push("executive session")), t.kind === "message" && ((d = t.message) != null && d.role.toLowerCase().includes("assistant")) && (r += 20, s.push("assistant response")), kt(i) && (r += 25, s.push("decision language")), r += as(t), as(t) > 0 && s.push("recent evidence")), e === "summarize" && ((t.kind === "conversation" || t.kind === "source") && (r += 30, s.push("conversation source")), t.kind === "executive_session" && (r += 25, s.push("session summary"))), e === "show_evidence") {
  ...
  return e === "blockers" && (yn(i) && (r += 50, s.push("blocker language")), (t.kind === "executive_session" || t.kind === "message") && (r += 15, s.push("narrative evidence"))), n.length > 1 && n.every((f) => i.includes(f)) && (r += 20, s.push("all query terms matched")), { boost: r, reasons: s };
}
function kc(t, e, n) {
  var s, r, i;
  return {
...
function Rc(t, e, n = 30) {
  var u;
  const s = Rr(e), r = rc(e), i = De(r), o = ur(t, r, 80), c = new Map(t.records.map((f) => [f.id, f])), a = [];
  for (const f of o) {
    const p = c.get(f.recordId);
    if (!p)
      continue;
    const { boost: h, reasons: I } = Cc(p, s, i);
    a.push({
      ...kc(f, p, I),
      score: f.score + h
    });
...
function Dc(t, e) {
  const { intent: n, searchQuery: s, queryTerms: r, items: i } = Rc(t, e), o = bc(t, i, s).filter((u) => u !== null), c = i.filter((u) => u.kind === "executive_session");
...
function Kt(t, e) {
  ...
  for (const r of t)
    if (!s.has(r.recordId) && (s.add(r.recordId), n.push(Nc(r)), n.length >= e))
      break;
  return n;
}
function Lc(t) {
...
function Pc(t, e) {
  if (e.level === "insufficient")
    return `I found limited evidence for "${t.searchQuery}". ${e.rationale}. Consider refining the question or checking the Search screen for raw hits.`;
  const n = t.items.slice(0, 3), s = n[0];
  switch (t.intent) {
    case "decision": {
      const r = t.executiveSessions[0];
      if (r)
        return `Based on executive session evidence (${r.krcId ?? r.title}): ${r.excerpt}`;
      const i = t.messages.find((o) => {
        var c;
    ...
    case "summarize":
      return `Summary grounded in ${t.topKrcIds.slice(0, 3).join(", ") || "indexed sources"}: ${n.map((i) => i.excerpt).join(" ")}`.slice(0, 500);
    case "show_evidence": {
      const r = t.attachments[0];
    ...
    case "blockers": {
      ...
      return r.length === 0 ? `No explicit blocker language found for "${t.searchQuery}" in retrieved evidence. Showing closest matches only — confidence is reduced.` : `Blocker-related evidence (${r.length} hit(s)): ${r[0].excerpt}`;
    }
    default:
...
function Fc(t) {
  const e = [], n = t.items.slice(0, 6);
  if (n.length === 0)
    return "No evidence items available to summarize.";
  e.push(`Retrieved ${t.items.length} evidence record(s) for "${t.searchQuery}".`);
  for (const s of n) {
    const r = s.krcId ? `[${s.krcId}]` : `[${s.kind}]`;
    e.push(`- ${r} ${s.title}: ${s.excerpt}`);
  }
  return t.topKrcIds.length > 1 && e.push(`- Sources span ${t.topKrcIds.length} KRC records: ${t.topKrcIds.slice(0, 5).join(", ")}.`), t.attachments.length > 0 && e.push(`- ${t.attachments.length} attachment reference(s) included in evidence.`), e.join(`
`);
}
function Oc(t) {
  const e = [], n = /* @__PURE__ */ new Set();
...
class Uc {
  compose(e) {
    const n = Lc(e), s = Kt(e.items, 8), r = Kt(e.attachments, 6), i = Kt(e.relatedSources, 5);
    return {
      question: e.question,
      intent: e.intent,
      searchQuery: e.searchQuery,
      directAnswer: Pc(e, n),
      reasonedSummary: Fc(e),
      evidenceUsed: s,
      confidence: n,
      timeline: e.timeline,
      relatedSources: i,
...
async function jr(t, e, n, s) {
  const r = await xe(t), i = Dc(r, e), o = jc(i), c = _c(n), a = c != null && c.conversationId ? await bt(t, c.conversationId) : await Ur(t), l = await _r(t), d = xc({
    repositoryPath: t,
    question: e,
    evidence: i,
    conversation: c,
  ...
  }), u = Ge(), f = (n == null ? void 0 : n.providerId) ?? "mock";
  ...
  const p = { context: d, groundedAnswer: o }, h = s ? await u.reasonStream(p, s) : await u.reason(p), I = Oa(o, h);
  return Sc(t, I);
}
...
async function Kc(t, e, n, s) {
  return jr(t, e, { ...n, streaming: !0 }, s);
}
const Gc = "conversations", zc = "active.json";
function Sn(t) {
  return S.join(t, ".kae-sessions", Gc);
}
function En(t, e) {
  return S.join(Sn(t), `${e}.json`);
}
function Cn(t) {
  return S.join(Sn(t), zc);
}
async function Hc(t) {
  const e = Sn(t);
...
async function Br(t) {
  try {
    const e = await R.readFile(Cn(t), "utf8"), n = JSON.parse(e);
...
async function Zc(t, e) {
  try {
    const n = await R.readFile(En(t, e), "utf8"), s = JSON.parse(n);
...
async function Vc(t) {
  const e = await Br(t);
  return e ? Zc(t, e.conversationId) : null;
}
async function Kr(t, e) {
  await Hc(t);
  const n = En(t, e.conversationId);
  await R.writeFile(n, JSON.stringify(e, null, 2), "utf8");
  const s = {
    conversationId: e.conversationId,
    updatedAt: e.updatedAt
  };
  return await R.writeFile(Cn(t), JSON.stringify(s, null, 2), "utf8"), n;
}
function qc(t) {
...
async function Wc(t) {
  const e = qc();
  return await Kr(t, e), e;
}
async function Yc(t, e) {
  try {
    await R.unlink(En(t, e));
  } catch {
  }
  const n = await Br(t);
...
const Jc = /campaign\s+([\d.]+[a-z]?)\s*(?:[—–-]\s*([^\n.?]+)|(?=\s|$))/gi, cs = /\b(completed?|finished|implemented|shipped|passed|pass\b|done with)\b/i, Xc = /\b(import(?:ed)?|repair(?:ed)?|index(?:ed)?|rebuilt|snapshot|rollback)\b/i;
function fe(t, e, n) {
  return {
    id: W(),
    label: t.trim(),
...
function tu(t, e) {
  ...
  if (r && (s.currentCampaign = r), t.role === "user" && t.question && !e.currentObjective && (s.currentObjective = t.question.trim()), t.role === "assistant" && t.answer) {
    const o = [t.answer.directAnswer, t.answer.reasonedSummary].join(" "), c = t.question ? Rr(t.question) : "general";
    (c === "decision" || kt(o)) && (s.currentDecisions = Ie(e.currentDecisions, [
      fe(t.answer.directAnswer.slice(0, 160), t.question, t.turnId)
    ])), (c === "blockers" || yn(o)) && (s.currentBlockers = Ie(e.currentBlockers, [
      fe(t.answer.directAnswer.slice(0, 160), t.question, t.turnId)
    ])), (cs.test(o) || cs.test(t.displayText)) && (s.currentAccomplishments = Ie(e.currentAccomplishments, [
      fe(t.answer.directAnswer.slice(0, 160), t.question, t.turnId)
    ]));
...
function ru(t, e) {
  ...
  return s != null && s.followUpContext && (n.followUpContext = s.followUpContext), n.unfinishedWork = nu(n), n.recommendedNextAction = su(n), n;
}
const iu = "KAE";
function ou(t) {
...
async function au(t, e, n) {
  const s = ou(n.conversationId), r = Je(n.title || "Vigsy_Conversation"), i = `${s}_${r}_SESSION.md`, o = `ExecutiveSessions/${iu}/${i}`, c = S.join(t, o), a = `.kae-sessions/conversations/${n.conversationId}.json`, l = n.turns.filter((f) => f.role === "user" && f.question).slice(-3).map((f) => `- **Q:** ${f.question}`), d = [...n.turns].reverse().find((f) => f.role === "assistant");
...
function uu(t, e = Nr) {
  ...
  t.currentCampaign ? s.push(`${us(n)} we were working on ${t.currentCampaign}.`) : n > 0 && s.push(`${us(n)} we left off on ${t.title}.`);
...
async function ds(t, e) {
  const n = await bt(t, e.conversationId);
  if (n)
    return (n.lifecycle === "paused" || n.lifecycle === "closed") && (n.lifecycle = "active", n.updatedAt = (/* @__PURE__ */ new Date()).toISOString(), await qe(t, n), await gt(t, n)), n;
  const s = Mr(e.conversationId, e.title);
  return await qe(t, s), await gt(t, s), s;
}
async function du(t) {
  const e = await Ur(t);
  !e || e.lifecycle !== "active" || (e.lifecycle = "paused", e.pausedAt = (/* @__PURE__ */ new Date()).toISOString(), e.updatedAt = e.pausedAt, await qe(t, e), await gt(t, e, !1));
}
async function lu(t, e) {
  const n = await bt(t, e);
  if (!n)
    return;
  n.lifecycle = "archived", n.archivedAt = (/* @__PURE__ */ new Date()).toISOString(), n.updatedAt = n.archivedAt, await qe(t, n, { archive: !0 });
  const s = await tt(t);
  s.sessions = s.sessions.map((r) => r.conversationId === e ? { ...r, lifecycle: "archived", updatedAt: n.updatedAt } : r), s.activeSessionId === n.sessionId && (s.activeSessionId = void 0), s.lastSyncedAt = n.updatedAt, await Or(t, s);
}
async function fu(t, e) {
  const n = await bt(t, e.conversationId) ?? Mr(e.conversationId, e.title), s = ru(e, {
    ...n,
    lifecycle: e.turns.length > 0 ? "active" : n.lifecycle
  });
  s.executiveSessionPath = await au(t, s, e), await qe(t, s), await gt(t, s);
  const r = await Xe(t), i = await $e(t), o = await et(t);
  return {
    session: s,
...
async function mu(t) {
  const e = await tt(t);
  let n = null;
  return e.activeSessionId && (n = await In(t, e.activeSessionId)), uu(n, e.founderName);
}
const pu = /^(user|assistant|system|human|chatgpt|cursor)\s*:\s*(.*)$/i, hu = /^(user|assistant|system)$/i;
function gu(t) {
  var r;
  const e = t.trim();
  if (!e)
...
${a.text.trim()}`);
  return [
    ...
    "",
    "## Description",
    `${ls(n.sourceKind)} acquired by KAE.`,
...
async function Iu(t, e) {
  const n = gu(e.transcript);
  if (n.length === 0)
    throw new Error("Transcript is empty.");
  await Gs(t);
  const s = await vt(t) + 1, r = It(s), i = yu(e.title, n, e.sourceKind), o = Je(i), c = `${r}_${o}.md`, a = `${r}_${o}_SESSION.md`, l = `Sources/${ut}/${c}`, d = `ExecutiveSessions/${ut}/${a}`, u = wu(r, i, e, n), f = vu(r, i, l, e, n);
  await R.mkdir(S.join(t, "Sources", ut), { recursive: !0 }), await R.mkdir(S.join(t, "ExecutiveSessions", ut), {
    recursive: !0
  }), await R.writeFile(S.join(t, l), u, "utf8"), await R.writeFile(S.join(t, d), f, "utf8");
  const p = await Xe(t), h = await $e(t), I = await et(t);
  return {
    krcId: r,
...
async function Su(t) {
  const e = await Xe(t), n = await $e(t), s = await et(t);
  return {
...
class nt {
  ...
  async connect(e, n) {
    return fs(this.id, `${this.name} connected`);
  }
  async disconnect() {
  }
  async checkHealth(e) {
    return fs(this.id, `${this.name} is operational`);
  }
  async sync(e, n) {
    var i;
    const s = Date.now(), r = [];
    try {
      let o;
      return e && this.canHandle(e) ? o = (await an(this, e, n)).documents : o = await this.syncInternal(e, n), {
        success: !0,
        connectorId: this.id,
...
async function Gt() {
  return (await import("./index-0N-zAron.js")).chatGptConnector;
}
class Ru extends nt {
  constructor() {
    super(...arguments);
  ...
  async discover(n) {
    return (await Gt()).discover(n);
  }
  async extract(n) {
    return (await Gt()).extract(n);
  }
  async normalize(n) {
    return (await Gt()).normalize(n);
  }
  async syncInternal(n, s) {
    if (!n)
      throw new Error("ChatGPT sync requires a ZIP export file.");
    const { runConnectorPipeline: r } = await Promise.resolve().then(() => Si);
    return (await r(this, n, s)).documents;
  }
}
const bu = new Ru(), Au = /(?:youtube\.com\/watch\?v=|youtu\.be\/|youtube\.com\/embed\/)([A-Za-z0-9_-]{11})/, $u = /[?&]list=([A-Za-z0-9_-]+)/, Tu = /youtube\.com\/channel\/([A-Za-z0-9_-]+)/;
function ms(t) {
  const e = t.match(Au);
  if (e)
...
async function ps(t, e, n) {
  ...
  if (t.kind === "channel" && t.channelId) {
    ...
    return (s = n == null ? void 0 : n.log) == null || s.call(n, "info", `Fetching channel feed: ${r}`), [...(await We(r)).matchAll(/<yt:videoId>([^<]+)<\/yt:videoId>/g)].map((c) => c[1]).slice(0, e);
  }
  if (t.kind === "playlist" && t.playlistId) {
    const r = await We(`https://www.youtube.com/playlist?list=${t.playlistId}`);
    return [
...
function _u(t) {
  return [...t.matchAll(/<text[^>]*>([\s\S]*?)<\/text>/g)].map((n) => xu(n[1].replace(/\n/g, " ").trim())).filter(Boolean).join(`
`);
}
async function Nu(t) {
  try {
    const n = (await We(`https://www.youtube.com/api/timedtext?type=list&v=${t}`)).match(/lang_code="([^"]+)"/), s = (n == null ? void 0 : n[1]) ?? "en", r = await We(`https://www.youtube.com/api/timedtext?v=${t}&lang=${s}`), i = _u(r);
    if (i.trim())
      return i;
  } catch {
  }
...
async function Lu(t, e) {
  var l;
  const n = `https://www.youtube.com/watch?v=${t}`, s = await Du(`https://www.youtube.com/oembed?url=${encodeURIComponent(n)}&format=json`);
  let r = "", i, o;
  try {
    const d = await We(n), u = d.match(/"shortDescription":"((?:\\.|[^"\\])*)"/);
    u && (r = JSON.parse(`"${u[1]}"`));
  ...
  const c = await Nu(t), a = c.length > 0;
  return {
    videoId: t,
    title: s.title,
    description: r,
...
class Fu extends nt {
  ...
  async syncInternal(n, s) {
    var f, p;
    const r = gs(s.config.settings), i = Pu(s);
    if (r.length > 0)
      return r.filter((h) => !i || i.has(`youtube:${h.videoId}`)).map((h) => hs(h));
    ...
    const c = ms(o), a = Number(s.config.settings.maxVideos ?? 5), l = await ps(c, a, s), d = [], u = i ? l.filter((h) => i.has(`youtube:${h}`)) : l;
    for (const h of u) {
      (f = s.log) == null || f.call(s, "info", `Acquiring YouTube video ${h}`);
      const I = await Lu(h, s);
      d.push(hs(I)), (p = s.onProgress) == null || p.call(s, "extract", Math.round(d.length / u.length * 100));
    }
    return d;
  }
  async detectChanges(n) {
    const s = (/* @__PURE__ */ new Date()).toISOString(), r = gs(n.config.settings);
    if (r.length > 0) {
    ...
    if (!i)
      throw new Error("YouTube connector requires a video, playlist, or channel URL.");
    const o = ms(i), c = Number(n.config.settings.maxVideos ?? 5), l = (await ps(o, c, n)).map((d) => `youtube:${d}`);
    return {
      connectorId: this.id,
      checkedAt: s,
      cursor: l.join("|"),
...
class ju extends nt {
  ...
  async syncInternal(n, s) {
    ...
    const i = Mu(s), o = vs(s.config.settings);
    if (o.length > 0)
      return o.filter((l) => !i || i.has(`github:${l.id}`)).map((l) => ws(r, l));
  ...
  async detectChanges(n) {
    ...
    const o = String(n.config.settings.apiKey ?? "").trim(), c = await ys(r, {
      token: o || void 0,
...
const Bu = new ju(), Gr = [".md", ".markdown", ".txt"];
async function zr(t) {
  const e = [];
  let n;
  try {
...
class Ku extends nt {
  ...
  async normalize(n) {
    ...
    return n.rawDocuments.map((r) => {
      const i = r, o = Is(s, i.path, i.content);
      return {
        id: o.id,
        title: o.title,
        content: o.content,
...
const zu = ne("claude", "Claude Connector", "Acquire knowledge from Claude conversation exports.", ["export", "session"]), Hu = ne("cursor", "Cursor Connector", "Acquire knowledge from Cursor workspace sessions.", ["workspace", "session"]), Zu = ne("google-drive", "Google Drive Connector", "Acquire documents from Google Drive folders.", ["folder", "file"]), Vu = ne("onedrive", "OneDrive Connector", "Acquire documents from OneDrive folders.", ["folder", "file"]), qu = ne("notion", "Notion Connector", "Acquire pages and databases from Notion workspaces.", ["page", "database"]), Wu = ne("obsidian", "Obsidian Connector", "Acquire vault notes from Obsidian.", ["vault"]), Yu = ne("rss", "RSS Connector", "Acquire feed entries from RSS/Atom sources.", ["feed"]), Ju = ne("websites", "Websites Connector", "Acquire content from configured website URLs.", ["url", "sitemap"]), Xu = ne("podcasts", "Podcasts Connector", "Acquire show notes and transcripts from podcast feeds.", ["feed", "episode"]), Qu = [
  zu,
  Hu,
  Zu,
  Vu,
...
class nd {
  constructor() {
    ...
    _(this, "scheduler");
    _(this, "worker");
    this.scheduler = new Cu((e, n) => this.monitorConnector(e, n)), this.worker = new ku(this.scheduler);
    for (const e of td)
  ...
  async initialize(e) {
    this.repositoryPath = e, this.state = await oo(e);
    ...
    try {
      if (u = await i.sync(n, d), u.documents.length > 0) {
        ...
        if (u.itemsSkipped += u.documents.length - b.documents.length, u.documents = b.documents, b.documents.length > 0) {
          ...
          const A = await Su(this.repositoryPath);
...
class _e {
  ...
  async import(e, n) {
    throw new Ps(`Importer "${this.name}"`);
  }
}
class sd {
  constructor() {
...
const yt = new sd(), rd = 500, id = /* @__PURE__ */ new Set(["system"]);
function od(t) {
...
function Zr(t) {
  var c;
  const e = t.conversation_id ?? t.id ?? pd(), n = (((c = t.title) == null ? void 0 : c.trim()) || "Untitled Conversation").slice(0, 200), r = ud(t).map((a) => ld(a.message)).filter((a) => a !== null), i = r.filter((a) => a.isPastedTranscript).map((a) => a.text), o = [...new Set(r.flatMap((a) => a.fileReferences))];
  return {
    conversationId: e,
    title: n,
...
function ld(t) {
  ...
  return {
    ...
    isPastedTranscript: e === "user" && n.length >= rd,
    fileReferences: s
  };
}
function fd(t) {
...
function hd(t) {
  ...
  for (const n of t) {
    ...
    if (e.push(`### ${s}`), n.createTime && e.push(`*${gd(n.createTime)}*`), e.push(""), e.push(n.text), e.push(""), n.fileReferences.length > 0) {
...
function Vr(t, e, n = {}) {
  const { sharedAssetList: s } = n, r = hd(t.messages), i = t.pastedTranscripts.length > 0 ? `
...
const yd = "conversations.json", wd = [
...
function qr(t, e = {}) {
  ...
  dt(s);
  const o = new Ks(t).getEntries();
  (p = r == null ? void 0 : r.onZipOpened) == null || p.call(r, o.length), dt(s);
  const c = o.find((b) => !b.isDirectory && b.entryName.replace(/\\/g, "/").endsWith(yd));
  if (!c)
  ...
  (h = r == null ? void 0 : r.onConversationsJsonLocated) == null || h.call(r, a, l), dt(s);
  const d = c.getData().toString("utf8"), u = [];
  let f = 0;
  for (const b of o) {
    if (dt(s), b.isDirectory)
      continue;
    const C = b.entryName.replace(/\\/g, "/"), A = S.basename(C);
    if (wd.some((g) => g.test(A) || g.test(C)) || C.endsWith(".json") && !C.includes("/"))
      continue;
    f++;
    const T = {
      zipPath: C,
...
class vd {
  ...
  async extract(e) {
    const n = qr(e.source.path, { loadAssetData: !1 }), s = ad(n.conversationsJson);
    return {
      connectorId: this.id,
      source: e.source,
      rawDocuments: s,
...
async function Wr(t, e = {}) {
  ...
  try {
      ...
      callbacks: {
        ...
        onConversationsJsonLocated: (g, m) => {
          i = g, o = m, d("conversations-json-located", "running", {
            ...
            detail: `${g} (${Es(m)})`
          }), u("info", `conversations.json located: ${g} (${Es(m)})`);
        }
      }
    });
    Ss(e.signal), d("parsing-started", "running"), u("info", "Conversations parsing started…");
    const p = Hr(f.conversationsJson);
    ...
    const I = f.assets.map((g) => ({
      zipPath: g.zipPath,
      fileName: g.fileName
    })), b = h.map((g, m) => Vr(g, f.assets, {
      validationMode: !0,
      sharedAssetList: m === 0 ? I : void 0
    })), C = sn(Zt.id, b), A = rn(Zt.id, t, C), T = on(Zt, t, C, A);
...
async function Yr(t, e, n = {}) {
  ...
  try {
    ...
    const u = await ro(d.documents, e, t.name);
    ...
    const u = d instanceof Error ? d.message : String(d), f = u.includes("cancelled"), p = io(t.name, t.path, e, u);
...
function kn() {
  return S.join(Ae.getPath("userData"), "credentials");
}
function wt(t) {
  return S.join(kn(), `${t}.cred`);
}
function ks() {
  return S.join(kn(), ".mode");
}
function Rn() {
  return Qt.isEncryptionAvailable();
}
function Jr() {
...
async function $d(t, e) {
  ...
  if (await R.mkdir(kn(), { recursive: !0 }), Rn()) {
    const s = Qt.encryptString(n);
    await R.writeFile(wt(t), s), await R.writeFile(ks(), "secure", "utf8");
    return;
  }
  await R.writeFile(wt(t), Buffer.from(n, "utf8").toString("base64"), "utf8"), await R.writeFile(ks(), "dev-fallback", "utf8");
}
async function Xr(t) {
  try {
    const e = await R.readFile(wt(t));
    return Rn() ? Qt.decryptString(e) : Buffer.from(e.toString("utf8"), "base64").toString("utf8");
  } catch {
    return;
  }
}
...
function Xt() {
  return S.join(Ae.getPath("userData"), "kae-settings.json");
}
async function xd() {
  try {
    const t = await R.readFile(Xt(), "utf8"), e = JSON.parse(t), { aiApiKey: n, ...s } = e;
    return s;
  } catch {
    return {};
  }
...
async function _d(t) {
  ...
  await R.mkdir(S.dirname(Xt()), { recursive: !0 }), await R.writeFile(Xt(), JSON.stringify(n, null, 2), "utf8");
}
function bn(t) {
  return { ...Os, ...t };
}
const Rs = S.dirname(ai(import.meta.url));
...
let L = null, ce = null, ee = null, je = null, ti = null, ge = null, Vt = null, qt = null;
const ue = mi(), Z = new hi(), lt = [];
function F() {
...
function be() {
  return bn(ue.settings);
}
async function pe() {
  const t = be(), e = Ge();
  e.setSecureStorageMode(Jr()), e.setActive(t.aiProvider);
  const n = await ei(t.aiProvider);
  e.setCredentials({
    apiKey: n,
    model: t.aiModel,
    baseUrl: t.aiBaseUrl,
...
async function bs(t) {
  const e = be(), n = (t == null ? void 0 : t.providerId) ?? e.aiProvider, s = (t == null ? void 0 : t.apiKey) ?? await ei(n);
  return {
    providerId: n,
    apiKey: s,
...
function j(t, e, n, s) {
  ...
  return lt.unshift(r), lt.length > 500 && lt.pop(), L == null || L.webContents.send("kae:log-added", r), r;
}
async function Be() {
  try {
    await et(F()), L == null || L.webContents.send("kae:executive-briefing-updated");
  } catch (t) {
...
function H(t, e, n, s) {
  ...
  r && (r.status = n, r.detail = s), ni([...t]);
}
function Pd() {
  Cs.forEach((t) => yt.register(t)), Ci.register(qs), j("info", "system", `Registered ${Cs.length} connector plugin(s)`);
}
function As() {
  L = new Ts({
    width: 1280,
    ...
    title: `${Ns} — ${Ls}`,
    webPreferences: {
      preload: S.join(Rs, "preload.js"),
      contextIsolation: !0,
      nodeIntegration: !1
    }
  }), process.env.VITE_DEV_SERVER_URL ? (L.loadURL(process.env.VITE_DEV_SERVER_URL), L.webContents.openDevTools({ mode: "detach" })) : L.loadFile(S.join(Rs, "../dist/index.html")), L.on("closed", () => {
    L = null;
  });
}
function si(t) {
...
async function Od(t, e) {
  var y, w, E;
  const n = Date.now(), s = S.basename(t), r = S.extname(s), i = crypto.randomUUID(), o = { path: t, name: s, extension: r }, c = Ld();
  ni(c), await mt(`Confirm import started: ${s} (${t})`), H(c, "validate-zip", "running"), j("info", "import", `Pre-import validation gate: ${s}`);
  let a;
  try {
    ce != null && ce.valid && ce.filePath === t && ee && je === t ? (a = ce, await mt(
  ...
  const u = await Qs(F(), i), f = await lo(F(), {
    sessionId: i,
    connectorId: e,
    sourceFile: s,
  ...
  H(c, "create-snapshot", "complete", S.basename(u)), j("info", "repository", `Snapshot saved: ${u}`), H(c, "analyze-export", "running"), await mt(
    `Analyze export: using cached package=${!!(ee && je === t)}, documents=${(ee == null ? void 0 : ee.documents.length) ?? "unknown"}`
  );
  const p = {
    repositoryPath: F(),
    outputDirectory: ue.settings.outputDirectory,
    jobId: i,
    importPackage: je === t ? ee ?? void 0 : void 0,
    sourceZipPath: t,
    log: (k, $) => j(k, "import", $),
    onProgress: (k) => {
  ...
  const I = await qs.export(h.documents, F(), {
    log: (k, $) => j(k, "export", $),
    onProgress: (k) => {
  ...
  const A = Date.now() - n, T = yt.get(e), g = {
  ...
  try {
    g.importReportPath = await Go(F(), m), j("info", "import", `Import report saved: ${g.importReportPath}`);
  } catch (k) {
    const $ = k instanceof Error ? k.message : String(k);
    g.errors.push(`Import report: ${$}`), j("warn", "import", `Could not write import report: ${$}`);
  }
  H(c, "complete", "complete", `Done in ${(A / 1e3).toFixed(1)}s`), g.timeline = [...c], ti = g;
  const v = Z.getById(i);
  ...
  ), L == null || L.webContents.send("kae:job-updated", Z.getById(i)), Be(), L == null || L.webContents.send("kae:import-complete", g), g;
}
function Ud() {
  N.handle(
    "kae:get-importers",
  ...
  ), N.handle("kae:get-repository-config", () => ue.repository), N.handle("kae:set-repository-config", async (t, e) => (ue.repository = e, await te(), j("info", "repository", `Repository path set to ${e.path}`), ue.repository)), N.handle("kae:get-settings", () => be()), N.handle("kae:set-settings", async (t, e) => (ue.settings = bn(e), await _d(be()), await pe(), j("info", "settings", "Application settings updated"), be())), N.handle("kae:get-jobs", () => Z.getAll()), N.handle("kae:get-logs", () => lt), N.handle("kae:get-default-repository-path", () => Fs), N.handle("kae:get-repository-health", async () => ye(F())), N.handle("kae:get-git-readiness", async () => (await ye(F())).gitReadiness), N.handle("kae:get-repository-stats", async () => mr(F())), N.handle("kae:browse-repository", async () => Et(F())), N.handle(
    "kae:read-repository-file",
    async (t, e) => Ze(F(), e)
  ), N.handle("kae:parse-chatgpt-source", async (t, e) => {
    const n = await Ze(F(), e), s = pn(n);
    if (!s) return null;
    const r = new Set(s.fileReferences);
    for (const o of s.messages)
      for (const c of o.fileReferences) r.add(c);
    const i = await wo(F(), [...r]);
    return { parsed: s, assets: i };
  }), N.handle(
    "kae:read-repository-asset",
    async (t, e, n) => {
      const s = ft(e), r = await R.readFile(s), i = hn(r, n ?? S.basename(e)), o = e.replace(/\\/g, "/");
      return {
    ...
    const t = await Xe(F());
    return await $e(F()), Be(), Ao(t);
  }), N.handle("kae:search-knowledge", async (t, e) => {
    const n = await lr(F(), e);
    return dr(n);
  }), N.handle(
    "kae:resolve-evidence-drilldown",
    async (t, e, n) => wa(F(), e, n)
  ), N.handle(
    "kae:answer-knowledge-question",
    async (t, e, n) => {
      const s = await bs(n);
      return await pe(), Bc(F(), e, s);
    }
  ), N.handle(
    "kae:answer-knowledge-question-stream",
    async (t, e, n) => {
      const s = await bs({ ...n, streaming: !0 });
      return await pe(), Kc(F(), e, s, (r) => {
        t.sender.send("kae:reasoning-stream-chunk", r);
      });
    }
  ), N.handle("kae:list-ai-providers", () => Ge().listCapabilities()), N.handle("kae:test-ai-provider", async (t, e) => {
    await pe();
    const n = Ge();
    return e && n.setActive(e), n.testProviderHealth(e ?? be().aiProvider);
  }), N.handle("kae:get-provider-health", async () => (await pe(), Ge().testActiveProviderHealth())), N.handle("kae:get-provider-key-status", async () => ({
    secureStorage: Jr(),
    providers: await Dd()
  })), N.handle("kae:set-provider-api-key", async (t, e, n) => (await $d(e, n), await pe(), Qr(e))), N.handle("kae:capture-live-session", async (t, e) => {
    const n = await Iu(F(), e);
    return Be(), L == null || L.webContents.send("kae:executive-briefing-updated"), L == null || L.webContents.send("kae:executive-memory-updated"), j("info", "live-capture", `Captured live session ${n.krcId}`, {
    ...
    async (t, e, n) => kr(F(), e, n)
  ), N.handle("kae:get-executive-briefing", async () => _r(F())), N.handle(
    "kae:refresh-executive-briefing",
    async () => et(F())
  ), N.handle("kae:load-active-vigsy-conversation", async () => {
    const t = await Vc(F());
    return t && await ds(F(), t), t;
  }), N.handle("kae:save-vigsy-conversation", async (t, e) => {
    const n = await Kr(F(), e);
    return e.turns.length > 0 && (await fu(F(), e), L == null || L.webContents.send("kae:executive-memory-updated"), L == null || L.webContents.send("kae:executive-briefing-updated"), L == null || L.webContents.send("kae:vigsy-refreshed")), n;
  }), N.handle("kae:create-vigsy-conversation", async () => {
    await du(F());
    const t = await Wc(F());
    return await ds(F(), t), t;
  }), N.handle("kae:delete-vigsy-conversation", async (t, e) => {
    await lu(F(), e), await Yc(F(), e);
  }), N.handle("kae:get-executive-continuity", async () => mu(F())), N.handle("kae:open-repository-path", async () => {
    await At.openPath(F());
  }), N.handle("kae:open-repository-file", async (t, e) => {
    await At.openPath(ft(e));
  }), N.handle("kae:reveal-repository-file", async (t, e) => {
    At.showItemInFolder(ft(e));
  }), N.handle("kae:copy-text", async (t, e) => (oi.writeText(e), !0)), N.handle("kae:get-last-validation", () => ce), N.handle("kae:get-last-import-summary", () => ti), N.handle("kae:get-last-repair-plan", () => Vt), N.handle("kae:get-last-repair-result", () => qt), N.handle("kae:select-zip-file", async () => {
    const t = await Tn.showOpenDialog({
    ...
    const t = await Yo(F());
    return Vt = t, qt = null, j("info", "repair", `Repair analysis complete: ${t.issues.length} issue(s), ${t.autoRepairCount} auto-repair action(s)`, {
    ...
    return qt = n, Vt = e, j("info", "repair", `Repository repair complete: ${n.filesChanged.length} file(s) changed`, {
    ...
    return Fd(e);
  }), N.handle("kae:cancel-validation", () => ge ? (ge.abort(), j("warn", "import", "Validation cancelled by user — repository unchanged"), si({
    status: "cancelled",
    stage: "cancelled",
    ...
    if (!e || !e.toLowerCase().endsWith(".zip"))
      throw new Error("Please select a valid .zip file. Repository unchanged.");
    return Od(e, "chatgpt-export-zip");
    ...
    return r.briefingGeneratedAt && Be(), r;
    ...
    const t = await Tn.showOpenDialog(L, {
...
Ae.whenReady().then(async () => {
  ue.settings = bn(await xd()), await pe(), $s.handle("kae-asset", async (t) => {
    const e = Nd(t.url), n = ft(e), s = await R.readFile(n), r = hn(s, S.basename(e));
    return new Response(s, { headers: { "Content-Type": r } });
  }), Pd(), await te(), Ud(), j("info", "system", `${Ns} started — ${Ls}`), As(), Ae.on("activate", () => {
    Ts.getAllWindows().length === 0 && As();
  });
});
Ae.on("window-all-closed", () => {
  process.platform !== "darwin" && Ae.quit();
});
export {
  _e as B,
  vd as C,
